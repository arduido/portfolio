function scrollToPortfolio() {
  return (
    $('html, body').animate({ scrollTop: $('#portfolio').offset().top }, 1e3),
    !1
  );
}
      ...
      $(window).scroll(function () {
        ...
        $('.Home').length
          ? (a >= $('#portfolio').offset().top - 175 &&
            ...
            a > 375 && $('#Container--1').addClass('animated fadeIn'),
            a > 1100 && $('#Container--2').addClass('animated fadeIn'),
            a > 1700 && $('#Container--3').addClass('animated fadeIn'),
            a > 2250 && $('#Container--4').addClass('animated fadeIn'),
            a > 2950 &&
            ...
            a > 5450 && $('#Container--6').addClass('animated fadeIn'))
          : $('*').css('opacity', '1');
      });
  });
